...
% Headers and footers: Blank header, name + page number in footer.
\makeatletter
\def\ps@plain{%
\def\@oddhead{}%
\def\@evenhead{}%
\def\@oddfoot{\footnotesize Conor Scott\hfill Page \thepage\ of \pageref*{LastPage}}%
\def\@evenfoot{\footnotesize Conor Scott\hfill Page \thepage\ of \pageref*{LastPage}}}
\makeatother
